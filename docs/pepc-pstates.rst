...
**--frequencies**
   ...
   in the case of an Intel platform, assume that all frequencies from '--min-freq-limit' to
...
**--turbo** *[on|off]*
   ...
   by the OS and thermal conditions. In the case of the 'intel_pstate' driver, use
