...
**Note on Hyper-Threading**: Hardware coordinates C-state requests by SMT siblings, choosing the
...
and PC6, preventing the system from benefiting from the energy savings provided by CC6 without
incurring the latency cost of PC6.
