...
"""
tpmi-spec-files-generator - generate pepc TPMI spec files from Intel proprietary TPMI XML files.
"""
...
def _get_cmdline_args(args: argparse.Namespace) -> _CmdlineArgsTypedDict:
    ...
    if typing.TYPE_CHECKING:
        input_dir = typing.cast(Path, input_dir)
        output_dir = typing.cast(Path, output_dir)
