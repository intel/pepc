...
PROPS = {
    ...
    "ppl1_enable_hw" : {
        "name" : "PPL1 enable via MSR",
        "type" : "bool",
        "sname": "package",
        "writable" : True,
    },
    "ppl1_clamp_hw" : {
        "name" : "PPL1 clamping via MSR",
        "type" : "bool",
        "sname": "package",
        "writable" : True,
    },
    "ppl1_window_hw" : {
        "name" : "PPL1 time window via MSR",
        "unit" : "s",
        "type" : "float",
        "sname": "package",
        "writable" : False,
    ...
    "ppl2_enable_hw" : {
        "name" : "PPL2 enable via MSR",
        "type" : "bool",
        "sname": "package",
        "writable" : True,
    },
    "ppl2_clamp_hw" : {
        "name" : "PPL2 clamping via MSR",
        "type" : "bool",
        "sname": "package",
        "writable" : True,
    },
    "ppl2_window_hw" : {
        "name" : "PPL2 time window via MSR",
        "unit" : "s",
        "type" : "float",
        "sname": "package",
        "writable" : False,
