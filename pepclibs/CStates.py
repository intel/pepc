...
from pepclibs.helperlibs import Procs, Trivial, FSHelpers, ToolChecker
...
class ReqCStates:
    ...
    def __init__(self, proc=None, cpuinfo=None, tchk=None):
        ...
        self._tchk.check_tool("find")
        self._tchk.check_tool("xargs")
        self._tchk.check_tool("cat")

    def close(self):
        """Uninitialize the class object."""

        for attr in ("_tchk", "_cpuinfo", "_proc"):
