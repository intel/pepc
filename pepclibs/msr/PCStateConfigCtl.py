...
_PKG_CST_LIMITS: Final[dict[int, _LimitsTypedDict]] = {
    ...
    # Clients.
    CPUModels.MODELS["NOVALAKE"]["vfm"]:         _CLIENT_LNL_CST_LIMITS,
    CPUModels.MODELS["NOVALAKE_L"]["vfm"]:       _CLIENT_LNL_CST_LIMITS,
    CPUModels.MODELS["WILDCATLAKE_L"]["vfm"]:    _CLIENT_LNL_CST_LIMITS,
