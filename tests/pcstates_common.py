...
def get_fellows(cpuinfo, cpu=0):
    """
    Return a dictionary where keys are scope names and values are all fellow CPUs (CPUs sharing the
    ...
    fellows = {}
    fellows["global"] = cpuinfo.get_cpus()
